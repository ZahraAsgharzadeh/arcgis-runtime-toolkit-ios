...
//  ARMetal
//
//  Created by Mark Dostal on 5/23/19.
...
class Renderer {
    ...
    func update(frame: ARFrame) {
        ...
        if let commandBuffer = commandQueue.makeCommandBuffer() {
            ...
            updateBufferStates()
            updateGameState(currentFrame: frame)
    ...
    func loadMetal() {
        ...
        do {
            ...
            metalLib = try device.makeDefaultLibrary(bundle: bundle)
        } catch {
            
        }
        guard let defaultLibrary = metalLib else { return }
    ...
    func updateGameState(currentFrame: ARFrame) {
